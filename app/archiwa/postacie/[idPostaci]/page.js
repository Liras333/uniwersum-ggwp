        ...
        <section className="whitespace-pre w-full md:w-4/5 mx-auto text-secondary-100">
            <article className="flex flex-col gap-5 text-wrap leading-6.5 ">
                ...
                <div className="grid grid-col-1 lg:grid-cols-[1fr_0.9fr]  gap-5 ">
                    <div className="inline-block relative  aspect-video">
                        ...
                        <div className="flex flex-col gap-5  h-full">
                            <p>
                                <DataStatusColor data={postac.pochodzenie}>Pochodzenie: </DataStatusColor>
                                {postac.pochodzenie}
                            </p>
                            <p>
                                <DataStatusColor data={postac.rokUrodzeniaSmierci}>Rok urodzenia i śmierci: </DataStatusColor>
                ...
                <div className="flex flex-col gap-4">   
                    <p>
                       <DataStatusColor data={postac.umiejetnosci}>Umiejętności: </DataStatusColor>
                        {postac.umiejetnosci}    
                    </p>  
                    <p>
                    ...
                    <p>
                        <DataStatusColor data={postac.powiazania}>Powiązania: </DataStatusColor>
                        {postac.powiazania || 'brak'}
                    </p>
                    <p>
                        <DataStatusColor  data={postac.dodatkowe}>Dodatkowe: </DataStatusColor>
