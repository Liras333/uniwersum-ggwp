...
import ExpandDescription from "@/app/_components/expandDescription";
import { getRandomPostac } from "@/app/_lib/service";
...
export default async function Page() {
  const postac = await getRandomPostac();
  return (
      ...
      <article className="flex flex-col gap-5 text-wrap leading-6.5 ">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            <ExpandDescription>{postac.opis}</ExpandDescription>
          </p>
          <p>
