...
export const metadata = {
  ...
  description:
    "Uniwersum G.G.W.P. Jest to wielki zbiór historii które miały miejsce na przestrzeni ponad 5 Epok ( około 12 500 lat). Wszystkie te wydarzenia miały miejsce na różnych światach.",
  icon: icon,
  authors: [
    {
      name: "Patryk Migała",
      url: "https://www.linkedin.com/in/patryk-miga%C5%82a/",
    },
  ],
};
